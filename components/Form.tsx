...
const Form = () => {
  return (
    <div className='bg-gray-400 grid h-screen'>
        <div className='bg-white p-10 w-80 h-auto text-center m-auto'>
          ...
          <div>
            ...
            <p className='text-xs mb-3'>Take your art to the next level.Get it
              ...
              <button className='bg-blue-800 text-xs font-semibold w-full text-white px-8 py-2 rounded-md'>Join with Facebook</button>
          ...
          <div className='grid grid-cols-1 gap-2 mb-3'>
            ...
            <button  className='bg-black text-xs font-semibold w-full text-white px-8 py-2 rounded-md'>Create New Account</button>
          </div>
          <div>
