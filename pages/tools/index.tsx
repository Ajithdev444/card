    ...
    <div className='bg-[#10182F] h-screen flex justify-center items-center'>
        <div className='bg-white h-4/5 w-10/12 rounded-md'>
            <div className='text-center py-6'>
                ...
                <p className='text-[10px]'>The latest tools that help you and your team
                    building software better,together.
                </p>
            </div>
            <div className='grid grid-cols-2 py-10 px-48 gap-8'>
                <div className='flex items-center lg:w-5/6 gap-4'>
                    ...
                    <p className='text-[10px]'>The top apps in the world rely on instabug for bug
                ...
                <div className='flex items-center lg:w-5/6 gap-4'>
                    ...
                    <p className='text-[10px]'>DeepScan is an advanced static analysis tools
                ...
                <div className='flex items-center lg:w-5/6 gap-4'>
                    ...
                    <p className='text-[10px]'>Octobox helps you manage your notifications in 
                ...
                <div className='flex items-center lg:w-5/6 gap-4'>
                    ...
                    <p className='text-[10px]'>Lean Board is a collaborative whiteboard with
                ...
                <div className='flex items-center lg:w-5/6 gap-4'>
                    ...
                    <p className='text-[10px]'>69% of data branches start with negligence. one
                ...
                <div className='flex items-center lg:w-4/6 gap-4'>
                    ...
                    <p className='text-[10px]'>The top apps in the world relay on Instabug for bug
                        reporting, crash reporting, and in-app user 
                        feedback.
                    </p>
                    </div>
